...
import simplifier
import converter
import ir_operator as operator
import type_checker
...
class Main:
    ...
    def start(self, args:str=None, filedata:str=None) -> int:
        ...
        the_lexer = lexer.Lexer(cli_args.input_files[0], filedata=filedata)
        tokens = the_lexer.tokens

        dbg("Lexical Analysis Finished!")
